...
export default function ContactForm() {
  ...
  return (
    <section className="py-10 bg-gradient-to-br from-amber-50 via-white to-red-50 relative rounded-2xl">
      {/* Custom Message Box */}
      {message && (
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 items-start relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full lg:ml-20">
